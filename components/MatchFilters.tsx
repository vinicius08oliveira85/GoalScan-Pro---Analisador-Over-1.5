...
const MatchFilters: React.FC<MatchFiltersProps> = ({
  ...
  return (
    <div className="mb-6 min-w-0 space-y-4">
      ...
      <div className="custom-card min-w-0 border border-base-300/50 p-4 shadow-inner shadow-primary/5 backdrop-blur-md dark:border-base-300/50 md:p-6">
        <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-end md:gap-6">
          ...
          <div className="flex-1 min-w-0 w-full sm:w-auto">
            ...
            <select
              ...
              className="select select-bordered h-11 min-h-[2.75rem] w-full border-base-300/50 bg-base-100/50 backdrop-blur-md"
            >
          ...
          <div className="flex-1 min-w-0 w-full sm:w-auto">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="input input-bordered h-11 min-h-[2.75rem] flex-1 border-base-300/50 bg-base-100/50 backdrop-blur-md"
              />
