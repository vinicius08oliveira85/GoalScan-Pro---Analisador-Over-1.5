...
export interface LeverageProgressionRow {
...
export interface Championship {
  ...
  /** Tipo de tabela a sincronizar do FBref (padrão: geral). Complemento em lote não usa API atual. */
  fbref_table_type?: TableType | null;
